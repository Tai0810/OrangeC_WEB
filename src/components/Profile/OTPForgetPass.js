      ...
      <div style={{ padding: 80 }}>
        <Row justify='center' style={{ width: '100%' }}>
          <Col span={14} style={{ alignItems: 'center' }}>
            <img src='./images/Hello.svg' alt='Hello' style={{ height: '600px', width: '100%' }} />
          </Col>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
                <input
                  name='verifi'
                  type='text'
                  style={{ backgroundColor: '#2E2E2E', width: '80%', height: '60px', borderRadius: '10px', marginTop: '30px', fontSize: '18px', padding: '15px', color: '#FFF', textAlign: 'center' }}
                  value={txtCode}
              ...
              <Row justify='center' style={{ width: '100%' }}>
                <Col span={12} style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
                  <Button
                    disabled={!isConfirm}
                    style={{
                      width: '80%', height: '60px', fontSize: '24px', color: '#FFFFFF', backgroundColor: isConfirm ? '#F24E1E' : 'gray', borderColor: '#F24E1E', marginTop: '100px', fontWeight: '600'
                    }}
                    onClick={() => {
                      if (txtCode == code) {
                        handlePass();
                  ...
                  <Button
                    style={{
                      width: '70%', height: '60px', backgroundColor: isResendEnabled ? '#F24E1E' : 'gray', borderRadius: 30, justifyContent: 'center', alignItems: 'center', marginTop: 20
                    }}
