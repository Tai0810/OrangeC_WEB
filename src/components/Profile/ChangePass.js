  ...
  return (
    <div style={{ background: '#1D1D1D', width: '100vw', height: '100vh' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        <Text style={{ fontSize: 17, fontWeight: 800, color: '#F24E1E', padding: 50, textDecoration: 'none' }}>OrangeC</Text>
                ...
                >
                  {({ handleChange, handleBlur, handleSubmit, values, errors, touched, isValid }) => (
                    <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
                      <input name='password' type='text' placeholder='Mật khẩu cũ' style={{ backgroundColor: '#2E2E2E', width: '60%', height: '60px', borderRadius: '10px', marginTop: '30px', fontSize: '18px', padding: '15px', color: '#FFF' }}
                        onChange={handleChange('oldpassword')}
                        onBlur={handleBlur('oldpassword')}
                        value={values.oldpassword}
                        error={errors.oldpassword && touched.oldpassword}
                      />
                      {errors.oldpassword && touched.oldpassword && <Text style={{ color: '#FFF', fontSize: 12 }}>{errors.oldpassword}</Text>}

                      <input name='newpassword' type='password' placeholder='Mật khẩu mới' style={{ backgroundColor: '#2E2E2E', width: '60%', height: '60px', borderRadius: '10px', marginTop: '30px', fontSize: '18px', padding: '15px', color: '#FFF' }}
                      ...
                      <input name='reppassword' type='password' placeholder='Nhập lại mật khẩu mới' style={{ backgroundColor: '#2E2E2E', width: '60%', height: '60px', borderRadius: '10px', marginTop: '30px', fontSize: '18px', padding: '15px', color: '#FFF' }}
