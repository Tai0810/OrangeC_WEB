    ...
    try {
      ...
      if (response.message === 'ok') {
        ...
        if (response.conversation) {
          localStorage.setItem('conversation', JSON.stringify(response.conversation));
        }
      ...
      <div style={{ padding: 20 }}>
        <Row justify='center'>
          <Col span={12} style={{ display: 'flex', alignItems: 'center', justifyContent: 'start' }}>
            <img src='./images/Hello.svg' style={{ height: '500px', width: '500px' }} alt='Hello' />
          </Col>
            ...
            <Formik
              ...
              validationSchema={Yup.object({
                ...
                dateOfBirth: Yup.date()
                  ...
                  .test('dob', i18next.t('ngaySinhKhongHopLe'), function (value) {
            ...
            >
              {({ handleChange, handleBlur, handleSubmit, values, errors, touched, isValid, setFieldValue }) => (
                <div style={{ width: '100%' }}>
                  <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
                    <div className='full-name' style={{ width: '100%' }}>
                      <input
                        ...
                        style={{ backgroundColor: '#2E2E2E', width: '100%', height: '60px', borderRadius: '10px', marginTop: '15px', fontSize: '18px', padding: '15px', color: '#FFF' }}
                      ...
                      <input name='phoneNumber' type='tel' placeholder='Số điện thoại' style={{ backgroundColor: '#2E2E2E', width: '100%', height: '60px', borderRadius: '10px', marginTop: '15px', fontSize: '18px', padding: '15px', color: '#FFF' }}
                    ...
                    <div style={{ width: '100%', display: 'flex', justifyContent: 'space-between', height: '50px', marginTop: '15px' }}>
                  ...
                  <div style={{ display: 'flex', marginTop: 20, justifyContent: 'center', width: '200px' }}>
                  ...
                  <Row justify='center'>
                    <Col span={12} style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center' }}>
                      <Button
                        ...
                        style={
                          isValid ? {
                            width: '440px', height: '60px', fontSize: '24px', fontWeight: '800px', color: '#FFFFFF', backgroundColor: '#F24E1E', borderColor: '#F24E1E', marginTop: '80px', fontWeight: '600'
                          } : {
                            width: '440px', height: '60px', fontSize: '24px', fontWeight: '800px', color: '#FFFFFF', backgroundColor: 'gray', borderColor: '#F24E1E', marginTop: '80px', fontWeight: '600'
                          }
                        }>
                        Tiếp tục
                      </Button>
