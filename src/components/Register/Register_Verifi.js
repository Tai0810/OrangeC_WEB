          ...
          <Col span={8} style={{ width: '100%' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'row', justifyContent: 'center', width: '100%' }}>
                ...
                <input name='verifi' type='text' style={{ backgroundColor: '#2E2E2E', width: '80%', height: '60px', borderRadius: '10px', marginTop: '30px', fontSize: '18px', padding: '15px', color: '#FFF', marginLeft: '10px', textAlign: 'center' }}
                  value={txtCode}
              ...
              <Row justify='center' style={{ width: '100%' }}>
                <Col span={12} style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
                  <Button disabled={!isComfirm}
                    style={
                      isComfirm ? {
                        width: '80%', height: '60px', fontSize: '24px', fontWeight: '800px', color: '#FFFFFF', backgroundColor: '#F24E1E', borderColor: '#F24E1E', marginTop: '100px', fontWeight: '600'
                      } : {
                        width: '80%', height: '60px', fontSize: '24px', fontWeight: '800px', color: '#FFFFFF', backgroundColor: 'gray', borderColor: '#F24E1E', marginTop: '100px', fontWeight: '600'
                      }
                    }
                    onClick={() => {
                      if (txtCode == code) {
